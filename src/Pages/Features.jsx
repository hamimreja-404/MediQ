...
export default function Features() {
  ...
  const gridItems = [
    ...
    },
    {
      ...
      desc: "Seamlessly slot in emergency patients between online bookings.",
      icon: <Users />,
    },
    {
      title: "Bank-Grade Security",
      desc: "256-bit encryption ensures patient data never leaks.",
      icon: <Shield />,
    },
    {
      title: "Offline Mode",
      desc: "Works even if internet drops. Syncs when back online.",
      icon: <Wifi />,
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-teal-500 selection:text-white">
      ...
      <section className="pt-32 pb-20 text-center px-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full">
          <img
            src="https://images.openai.com/static-rsc-3/lfBP7pWMpvjQblX3tii-9uylXn3yoHmoajAT3mgjQIH6JPlRwykBphHWRvTSrnE5JmdsqqjbDUMtkb-7WhF8K3EJlt0E17jQSuXrx0QMm3A?purpose=fullsize&v=1"
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full  text-teal-600 text-xs font-bold mb-6 border border-teal-200 z-99">
            <Zap size={14} className="text-yellow-500" />
            <span>Platform Capabilities</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 text-slate-300 leading-tight ">
            Everything you need to run a modern clinic.
          </h1>
          <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto">
            From booking to billing, MediQ automates the chaos so you can focus
            on the cure.
          </p>
        </motion.div>
      </section>
