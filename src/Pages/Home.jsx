  ...
  const steps_patient = [
    {
      ...
      text: "Search by specialty (e.g., Cardiologist) or location. View doctor profiles, fees, and available slots.",
    },
    {
      step: "02",
      title: "Book & Get Token",
      text: "Select a time slot. You will instantly receive a digital Token Number (e.g., #12) on your phone.",
    },
    {
      step: "03",
      title: "Live Track & Visit",
      text: "Check the app to see the 'Current Serving Token'. Arrive at the clinic only when your turn is near.",
    },
  ];
  ...
  const steps_doctor = [
    {
      ...
      text: "Create your partner account. Set your consultation fees, clinic timings, and daily patient capacity.",
    },
    {
      step: "02",
      title: "Start the Queue",
      text: "When you reach the clinic, click 'Go Live'. Your patients get notified that the doctor has arrived.",
    },
    {
      step: "03",
      title: "Digital Practice",
      text: "Call the next token with one click. Write e-prescriptions that are instantly saved to the patient's history.",
    },
  ];
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTotalDoctor(data.totalDoctor);
        setTotalPatient(data.totalPatient);
        console.log(totalDoctor, totalPatient);
      } catch (err) {
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
              Book appointments, track live queues, and manage medical records.
              Smart healthcare for modern clinics and patients.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div
              ...
              className="group p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-xl hover:shadow-teal-500/10 transition-all duration-300 hover:-translate-y-2"
            >
              ...
              <p className="text-slate-600 leading-relaxed">
                Track your token number in real-time. No more waiting in crowded
                clinic lobbies.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed">
                Book appointments in seconds. Select your specialty and
                preferred doctor effortlessly.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed">
                Your prescriptions and reports, always accessible on your phone
                securely.
              </p>
            </motion.div>
          </motion.div>
      ...
      <section className="py-16 bg-linear-to-r from-teal-600 to-blue-600 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/20">
            <div className="p-4">
              <div className="text-4xl font-bold mb-2">{totalDoctor}</div>
              <div className="text-teal-100 text-sm font-medium uppercase tracking-wide">
                Doctors
              </div>
            </div>
            <div className="p-4">
              <div className="text-4xl font-bold mb-2">{totalPatient}</div>
              <div className="text-teal-100 text-sm font-medium uppercase tracking-wide">
                Patients
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">
              A simple guide to getting started for everyone.
            </p>
          </div>
                  ...
                  (step, idx) => (
                    ...
                    >
                      <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col items-center text-center">
                        <div
                          className={`w-16 h-16 rounded-2xl flex items-center justify-center font-bold text-2xl mb-6 shadow-lg rotate-3 group-hover:rotate-0 transition-transform ${
                            manualTab === "patient"
