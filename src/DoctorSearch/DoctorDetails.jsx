...
//                 Join the consultation queue for today
//               </p>
//             </div>
...
//               className="w-full py-5 rounded-2xl bg-teal-600 text-white font-bold text-lg hover:bg-teal-700 transition-all shadow-xl shadow-teal-600/20 active:scale-[0.98] flex items-center justify-center gap-3"
//             >
//               Book Now
